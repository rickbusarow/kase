...
import com.rickbusarow.kase.UnscopedDynamicTestTransform
...
internal class DefaultTestNodeBuilder @PublishedApi internal constructor(
...
) : TestNodeBuilder, UnscopedDynamicTestTransform {
  ...
  override fun test(name: String, testAction: suspend () -> Unit) {
    nodes.add {
      DynamicTest.dynamicTest(name, testFunctionCoordinates.testUriOrNull) {
        runBlocking { testAction() }
      }
    }
  }
