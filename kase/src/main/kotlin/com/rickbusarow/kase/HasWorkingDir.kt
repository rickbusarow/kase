...
abstract class HasWorkingDir(workingDir: File) {
  ...
  companion object {
     ...
     *
     * @param testFunctionName details about the actual test function, so
    ...
    fun createWorkingDir(
      ...
      val testClassDirectoryName = testFunctionName.simpleNames
        // "MyTest/nested class"
      ...
      val working = baseWorkingDir / testClassDirectoryName / testFunctionDirectoryName / testVariantNames
