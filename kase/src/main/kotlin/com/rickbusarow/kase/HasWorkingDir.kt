...
abstract class HasWorkingDir(workingDir: File) {
  ...
  companion object {
     ...
     *
     * @param testFunctionLocation details about the actual test function, so
    ...
    fun createWorkingDir(
      ...
      val testFunctionName = testFunctionLocation.callingFunctionSimpleName
        .cleanForFileSystem()

      val testClassDirectoryName = testFunctionLocation.simpleNames
        // "MyTest/nested class"
      ...
      val working = baseWorkingDir / testClassDirectoryName / testFunctionName / testVariantNames
