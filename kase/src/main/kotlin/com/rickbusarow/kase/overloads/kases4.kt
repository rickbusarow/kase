...
public interface Kase4<out A1, out A2, out A3, out A4> : KaseInternal<KaseLabels4> {
  ...
  override val elements: List<KaseElement<Any?>>
    get() = listOf(a1, a2, a3, a4)
  override fun destructured(): List<KaseElement<Any?>> = elements
}

/** */
internal data class DefaultKase4<out A1, out A2, out A3, out A4>(
...
public data class KaseLabels4(
  ...
  override fun destructured(): List<String> {
    return listOf(a1Label, a2Label, a3Label, a4Label)
  }
}
