...
// /** */
// @JvmName("asTestsKase6Kase")
// public inline fun <K, A1, A2, A3, A4, A5, A6> Iterable<Kase6<A1, A2, A3, A4, A5, A6>>.asTests(
//   labels: KaseLabels6 = KaseLabels6(),
//   crossinline testAction: (kase: K) -> Unit
// ): Stream<out DynamicNode>
//   where K : Kase6<A1, A2, A3, A4, A5, A6> {
...
// /** */
// @JvmName("testFactoryKase6Kase")
// public inline fun <K, A1, A2, A3, A4, A5, A6> testFactory(
...
// /** */
// @JvmName("testFactoryKase6Destructured")
// public inline fun <K, A1, A2, A3, A4, A5, A6> testFactory(
//   vararg kases: Kase6<A1, A2, A3, A4, A5, A6>,
//   labels: KaseLabels6 = KaseLabels6(),
//   crossinline testAction: (a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6) -> Unit
...
public interface Kase6<out A1, out A2, out A3, out A4, out A5, out A6> : Kase<KaseLabels6> {
  ...
  override fun <T> plus(label: String, value: T): Kase7<A1, A2, A3, A4, A5, A6, T>
}
/** */
@Poko
internal class DefaultKase6<out A1, out A2, out A3, out A4, out A5, out A6>(
  ...
  override fun <T> plus(label: String, value: T): DefaultKase7<A1, A2, A3, A4, A5, A6, T> {
    return DefaultKase7(
      a1Element = a1Element,
      a2Element = a2Element,
      a3Element = a3Element,
