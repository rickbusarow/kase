...
// /** */
// @JvmName("asTestsKase14Kase")
// public inline fun <K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> Iterable<Kase14<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14>>.asTests(
//   labels: KaseLabels14 = KaseLabels14(),
//   crossinline testAction: (kase: K) -> Unit
// ): Stream<out DynamicNode>
//   where K : Kase14<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> {
...
/** */
context(TestEnvironmentFactory<T>)
public inline fun <T, K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> Iterable<K>.asTests(
  labels: KaseLabels14 = KaseLabels14(),
...
// /** */
// @JvmName("testFactoryKase14Kase")
// public inline fun <K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> testFactory(
...
// /** */
// @JvmName("testFactoryKase14Destructured")
// public inline fun <K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> testFactory(
//   vararg kases: Kase14<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14>,
//   labels: KaseLabels14 = KaseLabels14(),
//   crossinline testAction: (a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10, a11: A11, a12: A12, a13: A13, a14: A14) -> Unit
...
/** */
context(TestEnvironmentFactory<T>)
public inline fun <T, K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> testFactory(
  vararg kases: K,
  labels: KaseLabels14 = KaseLabels14(),
  crossinline testAction: T.(a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10, a11: A11, a12: A12, a13: A13, a14: A14) -> Unit
): Stream<out DynamicNode>
...
public interface Kase14<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10, out A11, out A12, out A13, out A14> : Kase<KaseLabels14> {
  ...
  override fun <T> plus(label: String, value: T): Kase15<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14, T>
}
/** */
@Poko
internal class DefaultKase14<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10, out A11, out A12, out A13, out A14>(
  ...
  override fun <T> plus(label: String, value: T): DefaultKase15<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14, T> {
