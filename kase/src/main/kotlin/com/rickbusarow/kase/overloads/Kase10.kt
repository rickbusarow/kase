 ...
 */
@Poko
public abstract class AbstractKase10<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10>(
  override val a1: A1,
  override val a2: A2,
  override val a3: A3,
  override val a4: A4,
...
internal class DefaultKase10<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10>(
  ...
  displayNameFactory: KaseDisplayNameFactory<Kase10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>>
) : AbstractKase10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>(a1 = a1, a2 = a2, a3 = a3, a4 = a4, a5 = a5, a6 = a6, a7 = a7, a8 = a8, a9 = a9, a10 = a10, displayNameFactory = displayNameFactory) {
