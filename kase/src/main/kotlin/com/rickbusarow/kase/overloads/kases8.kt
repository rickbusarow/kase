...
public interface Kase8<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8> : KaseInternal<KaseLabels8> {
  ...
  override val elements: List<KaseElement<Any?>>
    get() = listOf(a1, a2, a3, a4, a5, a6, a7, a8)
  override fun destructured(): List<KaseElement<Any?>> = elements
}

/** */
internal data class DefaultKase8<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8>(
...
public data class KaseLabels8(
  ...
  override fun destructured(): List<String> {
    return listOf(a1Label, a2Label, a3Label, a4Label, a5Label, a6Label, a7Label, a8Label)
  }
}
