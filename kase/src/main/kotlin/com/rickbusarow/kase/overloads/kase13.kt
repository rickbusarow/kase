...
public interface Kase13<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10, out A11, out A12, out A13> : Kase {
  ...
  override fun <A14> plus(label: String, value: A14): Kase14<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> {
    return DefaultKase14(
      ...
      a14WithLabel = kaseParam(label = label, value = value),
...
internal class DefaultKase13<out A1, out A2, out A3, out A4, out A5, out A6, out A7, out A8, out A9, out A10, out A11, out A12, out A13>(
  ...
  override fun <A14> plus(label: String, value: A14): DefaultKase14<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14> {
    return DefaultKase14(
      a1WithLabel = a1WithLabel,
      a2WithLabel = a2WithLabel,
      a3WithLabel = a3WithLabel,
 ...
 * @param labels the [KaseLabels13] to use for this [Kase13]
 ...
 */
public fun <T, K, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13> TestEnvironmentFactory<T>.test(
  a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10, a11: A11, a12: A12, a13: A13,
  labels: KaseLabels13 = KaseLabels13(),
  ...
  this@TestEnvironmentFactory.test(
    kase = kase(a1 = a1, a2 = a2, a3 = a3, a4 = a4, a5 = a5, a6 = a6, a7 = a7, a8 = a8, a9 = a9, a10 = a10, a11 = a11, a12 = a12, a13 = a13, labels = labels),
...
@JvmName("asTestsKase13ExtensionDestructuredTestEnvironment")
public inline fun <T : TestEnvironment, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13> Iterable<Kase13<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13>>.asTests(
 ...
 */
context(TestEnvironmentFactory<T>)
@JvmName("testFactoryKase13VarargDestructuredTestEnvironment")
public inline fun <T : TestEnvironment, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13> testFactory(
  vararg kases: Kase13<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13>,
  crossinline testAction: T.(a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10, a11: A11, a12: A12, a13: A13) -> Unit
): Stream<out DynamicNode> {
  return testFactory {
    kases.asSequence().asTests { testAction(it.a1, it.a2, it.a3, it.a4, it.a5, it.a6, it.a7, it.a8, it.a9, it.a10, it.a11, it.a12, it.a13) }
  }
}
 ...
 */
context(TestEnvironmentFactory<T>)
@JvmName("testFactoryKase13IterableDestructuredTestEnvironment")
public inline fun <T : TestEnvironment, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13> testFactory(
  kases: Iterable<Kase13<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13>>,
  crossinline testAction: T.(a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10, a11: A11, a12: A12, a13: A13) -> Unit
): Stream<out DynamicNode> {
  return testFactory {
    kases.asTests { testAction(it.a1, it.a2, it.a3, it.a4, it.a5, it.a6, it.a7, it.a8, it.a9, it.a10, it.a11, it.a12, it.a13) }
  }
}
...
/**
 * Creates a new [KaseLabels13] with the given labels.
 *
 * @param a1Label the label for the [Kase13.a1] property.
 * @param a2Label the label for the [Kase13.a2] property.
 * @param a3Label the label for the [Kase13.a3] property.
 * @param a4Label the label for the [Kase13.a4] property.
 * @param a5Label the label for the [Kase13.a5] property.
 * @param a6Label the label for the [Kase13.a6] property.
 * @param a7Label the label for the [Kase13.a7] property.
 * @param a8Label the label for the [Kase13.a8] property.
 * @param a9Label the label for the [Kase13.a9] property.
 * @param a10Label the label for the [Kase13.a10] property.
 * @param a11Label the label for the [Kase13.a11] property.
 * @param a12Label the label for the [Kase13.a12] property.
 * @param a13Label the label for the [Kase13.a13] property.
 * @return a new [KaseLabels13] with the given labels.
 */
public fun labels(
  a1Label: String = "a1",
  a2Label: String = "a2",
