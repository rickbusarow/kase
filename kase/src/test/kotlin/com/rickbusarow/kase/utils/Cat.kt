...
data class Cat(
  val name: String,
  val age: Int,
  override val displayName: String = "Cat(name: '$name' | age: $age)"
) : Kase2<String, Int> {
  override val a1: String get() = name
  override val a2: Int get() = age
}

class CatTestEnvironment(
  val cat: Cat,
  ...
  class Factory : TestEnvironmentFactory<Cat, CatTestEnvironment> {
    override fun createEnvironment(
      params: Cat,
      names: List<String>,
      location: TestLocation
    ): CatTestEnvironment = CatTestEnvironment(
      cat = params,
